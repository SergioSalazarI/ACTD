...
df = pd.DataFrame({
    "Fiebre": ["Medio", "Leve", "Alta", "Medio", "Leve", "Alta"],
    "No. Casos": [10, 2, 14, 8, 9, 3],
...
fig = px.bar(df,
             ...
             barmode="group",
             opacity=0.7,
             title="Comparación de los diagnósticos",
             color_discrete_sequence=["#006400","#9932CC"])

app.layout = html.Div(children=[
    html.H1(children='Mi primer tablero en Dash - My Version'),
